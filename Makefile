...
GROK_PORT_BRANCH ?= agent/grok-tui-port
GROK_PORT_ENDPOINT_1 ?= http://100.73.235.38:8001/v1
GROK_PORT_MODEL ?= GLM-5.3-Flash-NVFP4
GROK_PORT_MIN_SURFACES ?= 8
GROK_PORT_MAX_SURFACES ?= 16
GROK_PORT_MAX_CONCURRENT_1 ?= 32
