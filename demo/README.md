...
| [`defending-code/`](defending-code/README.md) | Threat model → scoped static-review swarm → document-triggered verifier fan-out → adversarial reduction → document-only patch drafts → isolated patch review → campaign report |
