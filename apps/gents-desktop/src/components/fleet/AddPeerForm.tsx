    ...
    <div className="fleet-pairing">
      ...
      >
        ...
        {pairingStatus ? (
          <p
            aria-live="polite"
            className={pairingError ? "fleet-inline-error" : "fleet-pairing-success"}
      ...
      <details className="fleet-manual-disclosure">
        ...
        <p className="muted">
          Diagnostic fallback only. Manual <code>/status</code> imports do not exchange
          signed membership claims.
        </p>
