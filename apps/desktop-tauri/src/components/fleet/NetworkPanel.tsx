...
import { fetchNetworkStatus } from "../../lib/desktop-api";
import type { NetworkStatusView } from "../../lib/types";
import { CopyButton } from "../CopyButton";
import { formatRelativeTime } from "./fleetMetrics";
    ...
    <section className="network-panel" data-testid="network-panel">
      ...
      {open ? (
        <div className="network-body">
          ...
          {error ? (
            <p className="network-error" data-testid="network-error" role="alert">
                ...
                <table className="network-replicators">
                  ...
                  <tbody>
                    {status.replicators.map((replicator, index) => {
                      ...
                      return (
                        <tr key={`${id}-${index}`}>
                          <td className="mono" title={replicator.address ?? undefined}>
