      ...
      <details className="tool-item code-tool" data-testid="code-file-edit">
        <summary className="tool-item-summary">
          <span className="tool-item-summary-left">
            <span
              aria-hidden="true"
              className="tool-item-dot tool-item-dot-success"
            />
        ...
        {view.overwrite ? (
          <div className="tool-item-body">
            <div className="muted small" data-testid="code-overwrite-note">
              Replaced the file&apos;s previous contents — no diff basis exists.
              New contents:
            </div>
            <div className="code-output">
              ...
              <pre
                ...
                data-testid="code-overwrite-content"
              >
      ...
      <div className="tool-item-body">
        ...
        view.cwd ? (
          <div className="code-command-meta muted small">
            {view.durationMs != null ? (
              <span data-testid="code-duration">
