      ...
      >
        ...
        <td>
          <div className="mcp-health-last-probe">
            <span>
              {formatRelative(service.lastProbeAt ?? service.lastSeen)}
            </span>
            {backoff ? (
              <span
            ...
            {probeOutcome && probeText ? (
              <span
                className={`mcp-health-probe-result${
                  probeOutcome.error || probeOutcome.lastError
                    ? " is-error"
                    : ""
                }`}
                role="status"
        ...
        <td>
          {service.lastErrorMessage ? (
            ...
            <span className="mcp-health-last-error mcp-health-last-error-muted">
              —
            </span>
          )}
        </td>
  ...
  if (k <= 1) {
    return (
      <div className="mcp-health-k-cell">
        <span className="mcp-health-k-badge mcp-health-k-badge-single">
          K=1
        </span>
