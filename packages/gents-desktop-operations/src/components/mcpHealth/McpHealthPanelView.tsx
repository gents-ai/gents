...
import { McpHealthFilters, McpHealthSummary } from "./McpHealthSummary.js";
import { McpHealthTable } from "./McpHealthTable.js";
import {
  formatRelative,
  matchesFilter,
  projectStatus,
      ...
      <header className="mcp-health-header">
        <div>
          ...
          <p className="mcp-health-subtitle">
            Registered <code>ToolServiceRegistry</code> entries with their most
            recently persisted health state.
          </p>
        </div>
        <button
          type="button"
