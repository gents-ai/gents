...
export type DeploymentView = { peerId: string, label: string, agentDid: string, addr: string, source: string | null, graphql: string | null, dialSucceeded: boolean, pairingReady: boolean, lastError: string | null, defaultBehaviorId: string | null, agentPrincipal: AgentPrincipalView, runtime: RuntimeView | null, behaviors: Array<BehaviorView>, inferenceBackends: Array<InferenceBackendView>, inferenceProfiles: Array<InferenceProfileView>, toolSelections: Array<ToolSelectionView>, toolServiceRegistries: Array<ToolServiceRegistryView>, skills: Array<SkillView>, tasks: Array<TaskView>, schedules: Array<ScheduleView>, eventTriggers: Array<EventTriggerView>, conversations: Array<ConversationSummary>, };
