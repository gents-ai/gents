...
const defaultDesktopApiAdapter: DesktopApiAdapter = {
  ...
  initLocalStandardRuntime(request) {
    return invokeDesktop<InitSummary>("desktop_init_local_standard", {
      request,
    });
  },
  startDesktopClient() {
  ...
  addPeer(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_peer_add", {
      request,
    });
  },
  pairBearer(request) {
  ...
  removePeer(peerId) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_peer_remove", {
      peerId,
    });
  },
  ...
  explainToolSurface(agentDid, behaviorId) {
    return invokeDesktop<ToolSurfaceExplanationView>(
  ...
  fetchSessionSnapshot(sessionId, agentDid, requestId) {
    return invokeDesktop<DesktopSessionSnapshot | null>(
  ...
  resendRequest(requestId) {
    return invokeDesktop<RequestResendResult>("desktop_request_resend", {
      requestId,
    });
  },
  ...
  saveBehaviorConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_behavior_save", {
      request,
    });
  },
  saveSkillConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_skill_save", {
      request,
    });
  },
  deleteSkillConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_skill_delete", {
      request,
    });
  },
  deleteTaskConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_task_delete", {
      request,
    });
  },
  deleteScheduleConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_schedule_delete", {
      request,
    });
  },
  deleteEventTriggerConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>(
  ...
  deleteBackendConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_backend_delete", {
      request,
    });
  },
  ...
  deleteBehaviorConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_behavior_delete", {
      request,
    });
  },
  saveBackendConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_backend_save", {
      request,
    });
  },
  probeInferenceEndpoint(endpoint) {
    return invokeDesktop<InferenceProbeResult>(
  ...
  saveTaskConfig(request) {
    return invokeDesktop<DesktopClientSnapshot>("desktop_task_save", {
      request,
    });
  },
  ...
  previewInterruptCascade(request) {
    return invokeDesktop<CascadeCancelPreview>(
...
export async function fetchRequestTimeline(
  agentDid: string,
  requestId: string,
) {
...
export async function fetchSessionSnapshot(
  ...
  return desktopApiAdapter().fetchSessionSnapshot(
    sessionId,
    agentDid,
    requestId,
  );
...
export async function deleteEventTriggerConfig(
  request: EventTriggerDeleteRequest,
) {
...
export async function deleteToolSelectionConfig(
  request: ToolSelectionDeleteRequest,
) {
  return desktopApiAdapter().deleteToolSelectionConfig(request);
}

export async function deleteToolServiceConfig(
  request: ToolServiceDeleteRequest,
) {
...
export async function listSubagentTree(
  request: DesktopListSubagentTreeRequest,
) {
