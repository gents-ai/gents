...
3. Lean/conformance/Rust revision, run, package, and code-review bundle core.
4. Grok usage normalization.
5. CLI install/run/watch/result vertical slice.
6. Documentation and removal of the obsolete checkout-relative demo.
7. Desktop catalog/run inspector.
8. Typed authoring and publish confirmation.
