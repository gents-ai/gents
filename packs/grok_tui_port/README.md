...
Every run lands under `packs/grok_tui_port/runs/<job-id>/`.
...
```bash
python3 packs/grok_tui_port/scripts/grok_edge_probe.py --edge offline
python3 packs/grok_tui_port/scripts/grok_edge_probe.py \
...
```mermaid
flowchart LR
    n0["PortIntegrateResult"]
    n1["port-converge-task"]
    n2["PortConvergenceReport"]
    n3["port-final-review-task"]
    n4["CallbackResult"]
    n5["port-implement-task"]
    n6["PortUnitClosure"]
    n7["port-integrate-task"]
    n8["WorkspaceReceipt"]
    n9["port-integrate-record-task"]
    n10["PortFinalReviewReport"]
    n11["port-live-task"]
    n12["PortLiveResult"]
    n13["port-live-review-task"]
    n14["PortReconAudit"]
    n15["port-plan-task"]
    n16["PortPlan"]
    n17["port-plan-skip-task"]
    n18["PortLiveReport"]
    n19["port-publish-task"]
    n20["GrokPortJob"]
    n21["port-recon-task"]
    n22["PortSurface"]
    n23["port-recon-audit-task"]
    n24["port-retry-task"]
    n25["port-review-task"]
    n0 -->|"port-converge"| n1
    n2 -->|"port-final-review"| n3
    n4 -->|"port-implement"| n5
    n6 -->|"port-integrate"| n7
    n8 -->|"port-integrate-record"| n9
    n10 -->|"port-live"| n11
    n12 -->|"port-live-review"| n13
    n14 -->|"port-plan"| n15
    n16 -->|"port-plan-skip"| n17
    n18 -->|"port-publish"| n19
    n20 -->|"port-recon"| n21
    n22 -->|"port-recon-audit"| n23
    n6 -->|"port-retry"| n24
    n8 -->|"port-review"| n25
```
<!-- pack-topology:end -->
