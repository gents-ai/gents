...
const AGENT_TOOL_CALL_FIELDS: &str = "tool_call_key session_id message_sequence tool_name tool_call_id args result status lifecycle_state cancel_policy deadline_at cancel_cause started_at completed_at selected_service_id selected_tool_name tool_failure_class latency_ms";
...
query DesktopRemoteSnapshot {
  ...
  AgentToolCall { tool_call_key session_id message_sequence tool_name tool_call_id args result status lifecycle_state cancel_policy deadline_at cancel_cause started_at completed_at selected_service_id selected_tool_name tool_failure_class latency_ms }
