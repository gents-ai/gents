    ...
    let store = ClientStore::from_rows(ClientStoreRows {
        ...
        tool_calls: vec![
            gents_protocol::row::AgentToolCallRow {
                ...
                result_doc_id: Some("result-historical-tool".to_string()),
                result_composite_commit_cid: Some("cid-result-historical-tool".to_string()),
                result_signer_did: Some("did:test:amy".to_string()),
                omission_doc_id: None,
                omission_composite_commit_cid: None,
                omission_signer_did: None,
                status: Some("completed".to_string()),
                lifecycle_state: Some("completed".to_string()),
...
fn session_snapshot_renders_structured_tool_payloads_in_timeline() {
    let store = ClientStore::from_rows(ClientStoreRows {
        ...
        tool_calls: vec![gents_protocol::row::AgentToolCallRow {
            ...
            result_doc_id: Some("result-tool-1".to_string()),
            result_composite_commit_cid: Some("cid-result-tool-1".to_string()),
            result_signer_did: Some("did:test:amy".to_string()),
            omission_doc_id: None,
            omission_composite_commit_cid: None,
            omission_signer_did: None,
...
fn structured_command_policy_denial_projects_to_rendered_tool() {
    let store = ClientStore::from_rows(ClientStoreRows {
        ...
        tool_calls: vec![gents_protocol::row::AgentToolCallRow {
            ...
            result_doc_id: Some("result-tool-denial".to_string()),
            result_composite_commit_cid: Some("cid-result-tool-denial".to_string()),
            result_signer_did: Some("did:test:amy".to_string()),
            omission_doc_id: None,
            omission_composite_commit_cid: None,
            omission_signer_did: None,
