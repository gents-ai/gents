...
use crate::commands::{
    delete_backend_config, delete_behavior_config, delete_context_config,
    ...
    save_skill_config, save_tool_service_config, save_tools_config, set_default_behavior,
...
use crate::types::{
    ...
    BehaviorSaveRequest, ContextDeleteRequest, DefaultBehaviorSetRequest, DesktopClientSnapshot,
    ...
    ToolServiceSaveRequest, ToolServiceTestRequest, ToolServiceTestResult, ToolsDeleteRequest,
...
#[tauri::command]
pub async fn desktop_default_behavior_set<R: Runtime>(
    app: AppHandle<R>,
    ...
    set_default_behavior(core.as_ref(), request)
        .await
        .map_err(|error| BridgeError::untyped(error.to_string()))?;
    emit_config_update_and_snapshot(&app, &core, &state).await
}
