...
fn export_all(dir: &Path) -> Result<(), String> {
    ...
    std::fs::write(
        dir.join("BridgeContractFingerprint.ts"),
        format!(
            "// Generated by gents-desktop-bridge typegen. Do not edit manually.\nexport const BRIDGE_CONTRACT_VERSION = {:?};\nexport const BRIDGE_PACKAGE_VERSION = {:?};\nexport const BRIDGE_WIRE_SCHEMA_HASH = {:?};\n",
            crate::contract::CONTRACT_VERSION,
            crate::contract::PACKAGE_VERSION,
            crate::contract::WIRE_SCHEMA_HASH,
        ),
    )
