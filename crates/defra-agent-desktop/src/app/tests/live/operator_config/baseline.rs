...
fn assert_behavior_section(
    ...
    let _ = open_operator_entity_and_assert_visibility(
        driver,
        deployment,
    ...
    .expect("operator behavior row should be visible");
...
fn assert_request_timeline_section(
    ...
    let timeline_texts = open_operator_request_timeline_and_assert_visibility(
        driver,
        deployment,
