...
pub use defra_agent_schemas::{
    ...
    CODEX_THREAD_PROJECTION_NAME, COMPACTION_ENTRY, COMPACTION_ENTRY_NAME, CONSUMED_INVITE_NONCE,
    CONSUMED_INVITE_NONCE_NAME, EVENT_TRIGGER, EVENT_TRIGGER_NAME, PEER_PAIRING_APPLIED,
