...
| `PeerRegistryDiscovery/DirectoryProjection.lean` | Agent directory projection (machine index v1): membership characterization, idempotent convergence, write-free settled fixpoint, retraction soundness. Fence: `tests/conformance/directory_projection.rs`. |
