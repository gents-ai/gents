//! Task 24 — end-to-end integration test for the full Trigger pipeline.
//!
...
//!      Task / Trigger docs — Trigger runtime resolution (and the
...
//!      that the Trigger's runtime-owned bookkeeping fields
