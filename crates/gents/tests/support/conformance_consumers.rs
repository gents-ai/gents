...
pub fn registered_conformance_consumers() -> &'static [ConformanceConsumer] {
    &[
        ...
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::session_state::session_snapshot_projection_consumes_generated_client_shell_contract_cases",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/session_state.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::session_state",
            function: "session_snapshot_projection_consumes_generated_client_shell_contract_cases",
        },
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::session_state::session_snapshot_binds_request_lifecycle_operator_ui_cases",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/session_state.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::session_state",
        ...
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::session_state::session_snapshot_streaming_response_overlay_consumes_generated_transition_cases",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/session_state.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::session_state",
        ...
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::session_state::session_snapshot_transcript_rendering_consumes_generated_transcript_cases",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/session_state.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::session_state",
        ...
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::session_timeline::structured_command_policy_denial_projects_to_rendered_tool",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/session_timeline.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::session_timeline",
            function: "structured_command_policy_denial_projects_to_rendered_tool",
        },
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::runtime::task_recent_runs_view_consumes_generated_trigger_dispatch_lineage_contract_cases",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/runtime.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::runtime",
            function: "task_recent_runs_view_consumes_generated_trigger_dispatch_lineage_contract_cases",
        },
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::subagent_lineage::subagent_tree_view_consumes_generated_r5_cross_deployment_contract_cases",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/subagent_lineage.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::subagent_lineage",
            function: "subagent_tree_view_consumes_generated_r5_cross_deployment_contract_cases",
        },
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::mcp_health::mcp_health_view_preserves_every_generated_lean_mcp_health_case_transition",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/mcp_health.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::mcp_health",
            function: "mcp_health_view_preserves_every_generated_lean_mcp_health_case_transition",
        },
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::operations_snapshot::tests::project_filters_to_background_await_mode_only",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/operations_snapshot/tests.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::operations_snapshot::tests",
        ...
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::tests::operations_cascade::preview_returns_four_classified_groups_and_a_signature",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/tests/operations_cascade.rs",
            module_path: "gents_desktop_tauri::bridge::tests::operations_cascade",
            function: "preview_returns_four_classified_groups_and_a_signature",
        },
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::tests::operations_interrupt::interrupt_request_cascade_returns_accepted_when_signature_matches",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/tests/operations_interrupt.rs",
            module_path: "gents_desktop_tauri::bridge::tests::operations_interrupt",
            function: "interrupt_request_cascade_returns_accepted_when_signature_matches",
        },
        ConformanceConsumer::RustTest {
            id: "gents_desktop_tauri::bridge::snapshot::tests::session_state::session_snapshot_derives_cancel_cause_for_interrupted_response_and_cancelled_tool_call",
            package: "gents-desktop-tauri",
            source_path: "apps/gents-desktop/src-tauri/src/bridge/snapshot/tests/session_state.rs",
            module_path: "gents_desktop_tauri::bridge::snapshot::tests::session_state",
