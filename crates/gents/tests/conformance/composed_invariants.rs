...
pub(super) async fn generated_composed_invariant_witnesses_drive_tool_lifecycle_conformance() {
    ...
    drive_interrupted_pending_witness(lean_composed_invariant_witness_by_scenario(C2_PENDING))
        .await;
    drive_interrupted_running_witness(lean_composed_invariant_witness_by_scenario(C2_RUNNING))
        .await;
}
