Configure a useful coding behavior now. Use previews before writes and inspect the resulting canonical documents.

- Create exactly one enabled behavior named `Onboarding Builder` using profile `onboarding-medium`.
