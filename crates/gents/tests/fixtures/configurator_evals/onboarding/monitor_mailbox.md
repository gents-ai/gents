Configure a full synthetic document-triggered monitoring automation, with behavior named Mailbox Monitor using the existing onboarding-medium profile and root {{ROOT}}. Keep Configurator/default and all inference configuration unchanged. No real machine inspection, shell commands, schedules or repairs are authorized.
