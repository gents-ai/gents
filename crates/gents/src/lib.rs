...
pub use schema::{
    ...
    AGENT_TOOL_OUTPUT_OMISSION_SCHEMA, AGENT_TOOL_RESULT_SCHEMA, COMPACTION_ENTRY_SCHEMA,
    GOAL_SCHEMA, INFERENCE_BACKEND_SCHEMA, INFERENCE_CALL_SCHEMA, INFERENCE_PROFILE_SCHEMA,
    OAUTH_CREDENTIAL_SCHEMA, SCHEDULE_SCHEMA, TASK_SCHEMA, TOOL_SELECTION_SCHEMA,
