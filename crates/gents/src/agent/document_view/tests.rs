...
fn empty_runtime_view(agent_did: &str) -> DocumentRuntimeView {
    DocumentRuntimeView {
        principal: DocumentRecord {
            ...
            fact: test_config_record("AgentPrincipal", agent_did, "principal").fact,
...
fn merge_surface_entries_match_inline_write_tools() {
    ...
    view.datastore_tool_surfaces.insert(
        ...
        DocumentRecord {
            ...
            fact: test_config_record("DatastoreToolSurface", "experiment-writes", "surf-doc").fact,
    ...
    let provenance =
        super::snapshot::linked_datastore_tool_surface_facts(&surface_selection, &view).unwrap();
    assert_eq!(
        provenance,
        vec![view.datastore_tool_surfaces["experiment-writes"]
            .fact
            .clone()],
        "resolved config provenance must pin the exact surface definition consumed"
    );
    assert_eq!(
...
fn merge_fails_closed_on_disabled_surface() {
    ...
    view.datastore_tool_surfaces.insert(
        ...
        DocumentRecord {
            doc_id: "surf-doc".to_string(),
            fact: test_config_record("DatastoreToolSurface", "disabled-writes", "surf-doc").fact,
            value: crate::document_config::DatastoreToolSurfaceDocument {
...
fn merge_fails_closed_on_foreign_agent_surface() {
    ...
    view.datastore_tool_surfaces.insert(
        ...
        DocumentRecord {
            doc_id: "surf-doc".to_string(),
            fact: test_config_record("DatastoreToolSurface", "foreign-writes", "surf-doc").fact,
            value: crate::document_config::DatastoreToolSurfaceDocument {
