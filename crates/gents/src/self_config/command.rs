    ...
    let contracts = match resource {
        ...
        Some("tools") => vec![patch_contract(
            ...
            json!({
                ...
                "integrations": {"lsp":{"config":"JSON encoded as a string|null","timeout_secs":"positive integer|null; default 20","max_timeout_secs":"positive integer|null; maximum 300","rpc_timeout_secs":"positive integer|null; default 30"},"eth_tool_ids":"array<existing same-principal EthTool ID>|null","plugins":"array<{plugin: installed namespace/name, digest: sha256:<hex>|null}>|null"},
