...
pub(super) fn help_patch_contracts(resource: Option<&str>) -> Value {
    let contracts = match resource {
        ...
        Some("tools") => vec![patch_contract(
            ...
            json!({
                "display_name": "string|null",
                "host": {"root":"string|null; absent uses runtime cwd", "files":{"mode":"Off|ReadOnly|ReadWrite (default Off)"}, "bash":{"mode":"Off|ReadOnly|Unrestricted (default Off)","execution_mode":"read_only|workspace_write|artifact_write|unrestricted|null","network_mode":"inherit|disabled|enabled|null","allowed_argv_prefixes":"array<array<string>>|null","forbidden_argv_prefixes":"array<array<string>>|null","read_only_commands":"array<string>|null","background_enabled":"boolean; default false","timeout_secs":"positive integer|null; default host --command-timeout-secs (120); clamped to the host maximum","max_timeout_secs":"positive integer|null; default timeout_secs if set, else host maximum; clamped to host --command-timeout-max-secs","background_timeout_secs":"positive integer|null; default 36000; clamped to 36000","wait_timeout_secs":"positive integer|null; default 30","max_wait_timeout_secs":"positive integer|null; default 600; clamped to 600","max_output_chars":"integer 1..1000000|null; default 16000; stdout and stderr each"}, "cli":"array<{name:string,timeout_secs?:positive integer (default host registration, 10; clamped to host --command-timeout-max-secs),max_output_chars?:integer 1..1000000 (default 16000)}>; default []"},
                ...
                "subagents": {"target_ids":"array<existing same-principal SubagentTarget ID>; default []","spawn_enabled":"boolean|null","steering_enabled":"boolean|null","background_enabled":"boolean|null","default_await_mode":"foreground|background|null","allow_cross_principal":"boolean|null","cross_principal_spawn_timeout_secs":"positive integer|null; default 60"},
                ...
                "integrations": {"lsp":{"config":"JSON encoded as a string|null","timeout_secs":"positive integer|null; default 20","max_timeout_secs":"positive integer|null; default 300; clamped to 300"},"eth_tool_ids":"array<existing same-principal EthTool ID>|null"},
        ...
        Some("profile") => vec![
            ...
            patch_contract(
                SelfConfigTarget::InferenceExecution,
                json!({
                    "display_name":"string|null","max_turns":"positive integer|null","max_total_tokens":"positive integer|null; null is unlimited","stream_batch_ms":"positive integer|null; default 1000","stream_liveness_timeout_secs":format!("positive integer|null; default {} and less than deadline", crate::config::DEFAULT_STREAM_LIVENESS_TIMEOUT_SECS),"provider_idle_timeout_secs":format!("positive integer|null; default {}", crate::config::DEFAULT_PROVIDER_IDLE_TIMEOUT_SECS),"deadline_duration_secs":"positive integer|null; default 86400","retry_policy_id":"existing same-principal retry policy ID|null","tags":"array<string>; default []"
                }),
            ),
            patch_contract(
                SelfConfigTarget::InferenceRetryPolicy,
