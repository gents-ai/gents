    ...
    let contracts = match resource {
        ...
        Some("tools") => vec![patch_contract(
            ...
            json!({
                ...
                "subagents": {"target_ids":"array<existing same-principal SubagentTarget ID>; default []; the agents create_session may address","enabled":"boolean|null; enables create_session and send_message"},
