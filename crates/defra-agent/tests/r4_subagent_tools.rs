...
#[path = "r4_subagent_tools/background_cancel.rs"]
mod background_cancel;
#[path = "r4_subagent_tools/cancel_subagent.rs"]
mod cancel_subagent;
#[path = "r4_subagent_tools/foreground_spawn.rs"]
mod foreground_spawn;
#[path = "r4_subagent_tools/spawn_validation.rs"]
mod spawn_validation;
#[path = "r4_subagent_tools/wait_subagent.rs"]
mod wait_subagent;
