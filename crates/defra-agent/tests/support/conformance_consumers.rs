...
pub fn registered_conformance_consumers() -> &'static [ConformanceConsumer] {
    &[
        ...
        ConformanceConsumer::RustTest {
            id: "defra_agent_desktop_tauri::bridge::snapshot::tests::session_state::session_snapshot_transcript_rendering_consumes_generated_transcript_cases",
            package: "defra-agent-desktop-tauri",
            source_path: "apps/desktop-tauri/src-tauri/src/bridge/snapshot/tests/session_state.rs",
            module_path: "defra_agent_desktop_tauri::bridge::snapshot::tests::session_state",
        ...
        ConformanceConsumer::RustTest {
            id: "defra_agent_desktop_tauri::bridge::snapshot::tests::session_timeline::structured_command_policy_denial_projects_to_rendered_tool",
            package: "defra-agent-desktop-tauri",
            source_path: "apps/desktop-tauri/src-tauri/src/bridge/snapshot/tests/session_timeline.rs",
            module_path: "defra_agent_desktop_tauri::bridge::snapshot::tests::session_timeline",
        ...
        ConformanceConsumer::RustTest {
            id: "defra_agent_desktop_tauri::bridge::snapshot::tests::mcp_health::mcp_health_view_preserves_every_generated_lean_mcp_health_case_transition",
            package: "defra-agent-desktop-tauri",
            source_path: "apps/desktop-tauri/src-tauri/src/bridge/snapshot/tests/mcp_health.rs",
            module_path: "defra_agent_desktop_tauri::bridge::snapshot::tests::mcp_health",
        ...
        ConformanceConsumer::RustTest {
            id: "identity_conformance::identity_permission_cases_pin_runtime_permission_contract_shape",
            package: "defra-agent",
            source_path: "crates/defra-agent/tests/identity_conformance.rs",
            module_path: "identity_conformance",
        ...
        ConformanceConsumer::RustTest {
            ...
            package: "defra-agent-cli",
            source_path: "crates/defra-agent-cli/src/http/r5_dispatch.rs",
        ...
        ConformanceConsumer::RustTest {
            id: "state_machine_conformance::generated_codex_shim_projection_cases_pin_adapter_mapping",
            package: "defra-agent",
            source_path: "crates/defra-agent/tests/state_machine_conformance.rs",
            module_path: "state_machine_conformance",
