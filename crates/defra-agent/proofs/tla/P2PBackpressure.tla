...
(* each inbound peer sends one DAG. Repeated organic writes/retry loops are *)
(* outside this first gate; the properties below are the local admission    *)
(* obligations that make those loops safe to retry.                         *)
(***************************************************************************)
