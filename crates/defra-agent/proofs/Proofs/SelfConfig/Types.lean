...
def allFields : Target → List FieldKey
  ...
  | .toolSelection =>
      ...
      , "subagent_targets", "subagent_spawn_enabled", "orchestration_enabled"
  ...
  | .inferenceProfile =>
      ...
      , "max_turns", "temperature", "stream_batch_ms"
...
def writableFields : Target → List FieldKey
  ...
  | .toolSelection =>
      ...
      , "backgroundable_tool_names", "subagent_targets"
  ...
  | .inferenceProfile =>
      ...
      , "temperature", "stream_batch_ms", "stream_liveness_timeout_secs"
