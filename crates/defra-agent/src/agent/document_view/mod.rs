...
use crate::document_config::{
    default_behavior_id_for_agent, AgentBehavior, AgentPrincipal, InferenceProfile,
...
pub(super) fn behavior_references_ready(view: &DocumentRuntimeView, behavior: &AgentBehavior) -> bool {
    let mut details = Vec::new();
