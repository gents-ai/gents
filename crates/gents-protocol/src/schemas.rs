...
pub use gents_schemas::{
    ...
    ETH_TOOL, ETH_TOOL_NAME, EVENT_SOURCE, EVENT_SOURCE_NAME, EVENT_GROUP_STATE,
    EVENT_GROUP_STATE_NAME, GOAL, GOAL_CREATION_CLAIM, GOAL_CREATION_CLAIM_NAME, GOAL_NAME,
